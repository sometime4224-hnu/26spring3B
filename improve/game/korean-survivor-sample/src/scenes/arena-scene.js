(function () {
  class ArenaScene extends Phaser.Scene {
    ...
    triggerStrongWave(waveNumber) {
      if (this.roundEnded || this.isLevelUp || this.finalBossPhase || this.stageBossSequenceStarted) {
        return;
      }
      ...
      this.showFloatingText(360, 276, `강습 ${waveNumber}`, "#ffe5c2", "34px");
    ...
    beginStageBossSequence() {
      ...
      this.showFloatingText(360, 276, "보스 준비", "#ffe5c5", "30px");
      this.refreshHud();
    }
    ...
    openStageTransition(nextStageIndex, bossWord) {
      ...
      rewards.forEach((reward, index) => {
        ...
        const title = this.add.text(position.x, position.y - 84, reward.label, {
          fontFamily: this.font,
          fontSize: "30px",
          fontStyle: "900",
        ...
        const viTitle = this.add.text(position.x, position.y - 44, reward.viLabel || "", {
          fontFamily: this.font,
          fontSize: "15px",
          fontStyle: "700",
          color: "#9ac7b2",
        ...
        const desc = this.add.text(position.x, position.y + 20, reward.description || "", {
          fontFamily: this.font,
          fontSize: "18px",
          fontStyle: "700",
          color: "#edf5fb",
        ...
        const viDesc = this.add.text(position.x, position.y + 86, reward.viDescription || "", {
          fontFamily: this.font,
          fontSize: "13px",
          color: "#a3c7b6",
          align: "center",
    ...
    beginFinalBossAfterReward() {
      ...
      this.isLevelUp = false;
      this.pauseAction(false);
      this.showFeedback("최종 결전 시작", "#ffc7b2");
